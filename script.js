...
function createChat() {
    ...
    else if(inpt.toLowerCase().includes(" self")||inpt.toLowerCase().includes("introduce your self")||inpt.toLowerCase().includes(" about you")||inpt.toLowerCase().includes("know about you")||inpt.toLowerCase().includes("introduce your self")||inpt.toLowerCase().includes("introduction")){
    ...
    else if(inpt.toLowerCase().includes("work at")||inpt.toLowerCase().includes("wish to work at our company")||inpt.toLowerCase().includes("want to work at our company")||inpt.toLowerCase().includes("work for our company")){
    ...
    else if(inpt.toLowerCase().includes("experiences")||inpt.toLowerCase().includes("experience")){
        msg.textContent = "please specify it.";
        document.getElementById("input").value="";
    }
    else if(inpt.toLowerCase().includes("job roles")||inpt.toLowerCase().includes("domain")){
        msg.textContent = "Frontend Web developer";
        document.getElementById("input").value="";
    }
    else{
